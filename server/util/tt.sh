...
# Step 10: Generate Receivers Table from Delayney
./bin/wps_scripts -w ./ -s noisemodelling/wps/Receivers/Delaunay_Grid.groovy -tableBuilding BUILDINGS -sourcesTableName POINT_SOURCE